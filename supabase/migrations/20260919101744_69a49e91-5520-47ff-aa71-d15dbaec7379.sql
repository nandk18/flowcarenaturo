...
CREATE INDEX IF NOT EXISTS idx_patients_clinic_source_created
ON public.patients (clinic_id, lead_source, created_at DESC);
...
REVOKE ALL ON FUNCTION public.patient_list_metrics(uuid, text, text, text, timestamptz, timestamptz) FROM PUBLIC;
