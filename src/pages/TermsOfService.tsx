      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-foreground/90">
          <section>
            ...
            <p>By registering for or using FlowCare ("the Platform"), you ("the Clinic" or "User") agree to be bound by these Terms of Service. If you do not agree to these terms, you may not use the Platform. These terms constitute a legally binding agreement between you and FlowCare Technologies.</p>
          </section>

          <section>
            <h2 className="font-display text-lg font-semibold text-foreground mb-2">2. Eligibility</h2>
            <p>FlowCare is intended solely for use by:</p>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
              ...
              <li>You must notify us immediately of any unauthorized access at <a href="mailto:security@flowcare.app" className="text-primary underline">security@flowcare.app</a></li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2 text-muted-foreground">
              ...
              <li>FlowCare acts as a Data Processor on behalf of the clinic</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 text-muted-foreground">
              <li>FlowCare is offered on a subscription basis with plans as published on our website</li>
          ...
          <section>
            ...
            <p>FlowCare and all associated software, designs, algorithms, and content are the intellectual property of FlowCare Technologies. You are granted a limited, non-exclusive, non-transferable license to use the Platform for its intended purpose. Patient data entered by clinics remains the property of the clinic.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2 text-muted-foreground">
              <li>FlowCare shall not be liable for any clinical outcomes resulting from use of the Platform</li>
          ...
          <section>
            ...
            <div className="border border-border rounded-lg p-4 bg-muted/30">
              <p className="font-semibold">FlowCare Technologies</p>
              <p className="mt-1">Email: <a href="mailto:legal@flowcare.app" className="text-primary underline">legal@flowcare.app</a></p>
            </div>
          </section>
        </div>
      </div>
